...
class ProjectService {
    ...
    public function saveProjectLink($projectId, $linkName, $link) {
        return $this->getProjectDao()->saveProjectLink($projectId, $linkName, $link);
    }

    public function getProjectLinkList($projectId) {
        return $this->getProjectDao()->getProjectLinkList($projectId);
    }

    public function deleteProjectLink($linkId) {
        return $this->getProjectDao()->deleteProjectLink($linkId);
    }
