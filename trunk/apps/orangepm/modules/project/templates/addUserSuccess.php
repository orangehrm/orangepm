    ...
    <div class="addForm">
        ...
        <div class="formField">
            <form id="addUser" action="<?php echo url_for('project/addUser') ?>" method="post" onsubmit="return addUserInputsValid( );" >
                <div id="form">
                    <div><span class="mandatoryStar">*</span> <?php echo $userForm['firstName']->renderLabel() ?><?php echo $userForm['firstName']->render() ?><?php echo $userForm['firstName']->renderError() ?></span><br class="clear" /></div>
                    ...
                    <div><span class="mandatoryStar">*</span> <?php echo $userForm['userType']->renderLabel() ?><?php echo $userForm['userType']->render() ?><?php echo $userForm['userType']->renderError() ?><br class="clear" /></div>
                    <div><span class="mandatoryStar">*</span> <?php echo $userForm['username']->renderLabel() ?><?php echo $userForm['username']->render() ?><?php echo $userForm['username']->renderError() ?><br class="clear" /></div>
